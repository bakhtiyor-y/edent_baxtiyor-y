...
import { CityModel } from 'src/app/core/models/manuals';
...
export class CitiesComponent implements OnInit {
  ...
  public items: CityModel[];

  public selectedItems: CityModel[];

  public editItem: CityModel;
  ...
  add() {
    this.editItem = { id: 0 } as CityModel;
  ...
  deleteSelected() {
    this.confirmationService.confirm({
      ...
      icon: 'pi pi-exclamation-triangle',
      accept: () => {
        this.apiService.post('api/City/DeleteSelected', this.selectedItems)
          .toPromise()
          .then(th => {
  ...
  public loadData(event) {
    ...
    this.apiService.get('api/City', params).toPromise().then(th => {
      this.items = th.data;
